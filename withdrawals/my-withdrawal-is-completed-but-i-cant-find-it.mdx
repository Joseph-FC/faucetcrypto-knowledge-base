...
5. That said, at the Withdrawal Details Modal, either click the "copy" icon to copy the TxID and manually input/paste it into a related Block Explorer for the associated crypto and search OR simply click the "Link" icon to automatically open it in it's related Block Explorer and track the transaction.
6. Once it opens, generally (but using this Polygon withdrawal as an example on polygonscan) pay attention to a section that says "Status" (and/or "No. of Confirmations" for some network block explorers). Being marked as 'Success', 'Confirmed', 'Successful' or anything similar... with 1 or more No. of Confirmations is 100% verifiable assurance that the transaction was accurately sent. You can also see your address, amount transacted and other details pertaining to the whole withdrawal.