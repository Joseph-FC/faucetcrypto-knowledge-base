...
Your referral link can be found at the **Referral page** (under the **PROFILE section**) by scrolling down the left side menu of your dashboard. At the Referrals page, click on "**_Copy Link_**" to copy it.
