...
<Note>
  **Tips:** _To learn more about Coin's fixed price in USD, click on the '_**_?_**' icon found where the real-time equivalent amount of your selected favorite cryptocurrency is at the top of your **_Dashboard_**
</Note>