...
### **_How many exp. points do I need to advance to the next level?_**
...
2. Scroll down the left side menu and click the "**_?_**" sign where you have the Level progress bar to reveal a modal containing more information (including the amount of _exp. points_ needed to progress)

<Frame>
  ![Faucetcrypto Levelsytem Experiencepoints Pn](/images/faucetcrypto-levelsytem-experiencepoints.png)
</Frame>
